...
function Kaart() {
    ...
    return (
        <div>
            ...
            <button onClick={() => setPosition({center: [59.427397071157685, 24.723111285235372], zoom: 13})}>Kristiine</button>
            ...
            <button onClick={() => setPosition({center: [59.437, 24.755], zoom: 13})}>Viru keskus</button>
             <br />
             <button onClick={() => setPosition({center: [58.378002579680995, 26.730841769849597], zoom: 11})}>Kõik Tartu poed</button>
            <button onClick={() => setPosition({center: [58.359007313329776, 26.67712696721084], zoom: 13})}>Lõunakeskus</button>
            <button onClick={() => setPosition({center: [58.378002579680995, 26.730841769849597], zoom: 13})}>Tasku keskus</button>
        ...
        <MapContainer style={{"height": "300px", "margin": "3%", "border-radius": "10px"}} center={position.center} zoom={position.zoom} scrollWheelZoom={false}>
          ...
          <Marker position={[59.427397071157685, 24.723111285235372]}>
            <Popup>
              Kristiine keskus. <br /> Avatud 9-21.
            </Popup>
          </Marker>
          <Marker position={[58.359007313329776, 26.67712696721084]}>
            <Popup>
              Lõunakseskus <br /> Avatud 9-21.
            </Popup>
          </Marker>
          <Marker position={[58.378002579680995, 26.730841769849597]}>
            <Popup>
